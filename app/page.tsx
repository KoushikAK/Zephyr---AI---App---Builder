...
export default function Home() {
  ...
  const placeholders = [
    "Build a SaaS dashboard with real-time data",
    "Create a social app for photographers",
    "Make an e-commerce store with Stripe payments",
    "Build a productivity tool with AI summaries",
  ];
  ...
  return (
    <main className="min-h-screen bg-[#00000078] selection:bg-white/20">
      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg text-gray-400">
          Build production-ready AI applications with speed, quality, and
